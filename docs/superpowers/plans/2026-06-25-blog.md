...
- Table names are exactly `posts`, `posts_categories`, `posts_tags`, `posts_tags_pivot`.
...
- Deleting a category that has posts. Expected: posts survive with `posts_category_id` null, not deleted. Pinned by `test_deleting_category_keeps_its_posts`.
...
**Files:**
- Create: `database/migrations/2026_06_25_000001_create_posts_categories_table.php`
- Create: `database/migrations/2026_06_25_000002_create_posts_tags_table.php`
- Create: `database/migrations/2026_06_25_000003_create_posts_table.php`
- Create: `database/migrations/2026_06_25_000004_create_posts_tags_pivot_table.php`
...
`database/migrations/2026_06_25_000001_create_posts_categories_table.php`:
...
`database/migrations/2026_06_25_000002_create_posts_tags_table.php`:
...
`database/migrations/2026_06_25_000004_create_posts_tags_pivot_table.php`:
...
class PostTaxonomyResourceTest extends TestCase
{
    ...
    public function test_can_create_a_category(): void
    {
        ...
        $this->assertDatabaseHas('posts_categories', ['name' => 'Craft', 'slug' => 'craft']);
    }
    ...
    public function test_can_create_a_tag(): void
    {
        ...
        $this->assertDatabaseHas('posts_tags', ['name' => 'Process', 'slug' => 'process']);
    }
...
- [ ] **Step 4: Write the category resource**
...
- Produces: `PostResource::getUrl('index'|'create'|'edit')`; form fields named exactly `title`, `slug`, `excerpt`, `body`, `cover_image`, `posts_category_id`, `tags`, `author_id`, `status`, `published_at`, `is_featured`, `meta_description`.
...
class PostResourceTest extends TestCase
{
    ...
    public function test_can_create_a_post(): void
    {
        ...
        $this->assertSame($category->id, $post->posts_category_id);
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('posts_category_id')
                    ->label('Category')
                    ->relationship('category', 'name'),
...
- [ ] **Step 6: Write the resource and pages**
...
class PostsPageTest extends TestCase
{
    ...
    public function test_can_filter_by_category(): void
    {
        ...
        $inCategory = Post::factory()->create(['title' => 'In Craft', 'posts_category_id' => $category->id]);
...
- [ ] **Step 5: Add the route and layout lang keys**
...
class ShowPostTest extends TestCase
{
    ...
    public function test_related_posts_share_tags(): void
    {
        ...
        $post = Post::factory()->create(['posts_category_id' => $category->id, 'title' => 'Main Post']);
        $post->tags()->attach($tag->id);

        $related = Post::factory()->create(['posts_category_id' => $category->id, 'title' => 'Related Post']);
        $related->tags()->attach($tag->id);

        $unrelated = Post::factory()->create(['title' => 'Unrelated Post', 'posts_category_id' => null]);
...
class ShowPost extends Component
{
    ...
    public function related(): Collection
    {
        ...
        return Post::query()
            ...
            ->withCount(['tags as shared_tags_count' => fn ($query) => $query->whereIn('posts_tags.id', $tagIds)])
            ->orderByDesc('shared_tags_count')
            ->orderByRaw('CASE WHEN posts_category_id = ? THEN 0 ELSE 1 END', [$this->post->posts_category_id])
...
- [ ] **Step 5: Add the layout json_ld slot and og_type support**
...
- [ ] **Step 3: Update the sitemap route**
...
- [ ] **Step 4: Update the sitemap view**
    ...
    public function run(): void
    {
        ...
        foreach ($posts as $data) {
            ...
            $post = Post::create([
                ...
                'body' => $data['body'],
                'posts_category_id' => $categories[$data['category']]->id,
                'author_id' => $author?->id,
                'status' => Post::STATUS_PUBLISHED,
...
- [ ] **Step 8: Run the full suite and seed**
...
- [ ] Run `vendor/bin/pint --dirty` — formatting clean.
- [ ] Load `/en/blog` and `/en/blog/{slug}` in a browser; confirm nav Blog link, index grid, detail body, related posts, and that `/id/blog` renders the same posts with Indonesian chrome.
- [ ] Confirm a draft post returns 404 at `/en/blog/{draft-slug}`.
