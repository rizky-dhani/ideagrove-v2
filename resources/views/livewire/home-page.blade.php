<div>
            ...
            <div class="grid items-end gap-16 lg:grid-cols-12">
                <div class="lg:col-span-8">
                    ...
                    <p class="mt-8 max-w-xl text-base leading-relaxed text-warm-gray sm:text-lg">
                        Brand identities, websites, and applications for organisations that take their craft seriously. Hospitality, climate, culture, and beyond.
                    </p>
            ...
            <div class="grid gap-16 lg:grid-cols-12">
                ...
                <div class="lg:col-span-8">
                    <p class="max-w-2xl text-base leading-relaxed text-warm-gray sm:text-lg">
                        We move slowly on purpose. Every engagement begins with listening. To the founders, the customers, the place. The work that follows is shaped by what we hear, not by trend or template. Digital work that feels rooted, considered, and built to last.
                    </p>
                    ...
                    <div class="scroll-reveal-group mt-12 grid gap-10 sm:grid-cols-3 sm:gap-8">
                        ...
                        <div class="border-t border-peach-medium/60 pt-6">
                            ...
                            <p class="mt-2 text-sm leading-relaxed text-warm-gray">We stay close after launch, refining, extending, and protecting the work.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-6xl">
            ...
            <div class="scroll-reveal-group mt-14 grid gap-px overflow-hidden rounded-2xl border border-peach-medium/40 bg-peach-medium/40 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <article class="bg-cream p-8">
                    ...
                    <p class="mt-3 text-sm leading-relaxed text-warm-gray">Hand-crafted, performant builds. Typically Laravel &amp; Filament, occasionally bespoke.</p>
                </article>
                <article class="bg-cream p-8">
                    <svg class="mt-3 size-7 text-warm-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <section id="work" class="scroll-reveal px-6 py-24 sm:px-8 sm:py-28 lg:px-12 lg:py-32">
        <div class="mx-auto max-w-6xl">
            <div class="max-w-2xl">
                <span class="font-mono text-xs font-medium tracking-[0.2em] text-brand uppercase">/work</span>
                <h2 class="mt-4 font-serif text-3xl text-charcoal sm:text-4xl">Our work so far</h2>
                <p class="mt-4 text-base leading-relaxed text-warm-gray">
                    A curated selection of work we&rsquo;ve delivered. Always looking for the next collaboration.
                </p>
            </div>
            ...
            @else
                <div class="mt-14 rounded-xl border border-dashed border-peach-medium/60 px-8 py-20 text-center">
                    <p class="font-serif text-lg text-warm-gray/60">Work is loading.</p>
            ...
            <div class="grid gap-16 lg:grid-cols-12">
                <div class="lg:col-span-5">
                    ...
                    <p class="mt-6 max-w-md text-base leading-relaxed text-warm-gray">
                        If you&rsquo;re working on something meaningful, we&rsquo;d love to hear about it.
                    </p>
