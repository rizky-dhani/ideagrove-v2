<div>
    ...
    <section class="relative overflow-hidden bg-cream px-6 py-10 sm:px-8 lg:px-12">
        ...
        <div class="mx-auto flex max-w-4xl flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            <a href="{{ url('/') }}" class="inline-flex shrink-0 items-center gap-2 text-sm text-warm-gray/60 transition-colors hover:text-charcoal dark:text-warm-gray/80 dark:hover:text-white">
            ...
            <div class="text-left sm:text-right">
                <p class="mb-2 text-sm font-medium tracking-widest text-brand-light uppercase">/contact</p>

                <h1 class="font-serif text-3xl leading-tight text-charcoal sm:text-4xl lg:text-5xl">Get in touch</h1>
            ...
            <div class="grid gap-16 lg:grid-cols-12">
                ...
                <aside class="lg:col-span-5">
                    <div class="scroll-reveal space-y-10">
                        <div>
                            <h2 class="font-serif text-2xl text-charcoal sm:text-3xl">Reach out</h2>
                            <p class="mt-3 text-sm leading-relaxed text-warm-gray">
                                Prefer email or a call? We&rsquo;re here.
                            </p>
                        </div>

                        @if ($siteSetting?->email)
                            <div>
                                <h3 class="text-xs font-medium tracking-[0.2em] text-warm-gray uppercase">Email</h3>
                        ...
                        @if ($siteSetting?->phone_display)
                            <div>
                                <h3 class="text-xs font-medium tracking-[0.2em] text-warm-gray uppercase">Phone</h3>
                        ...
                        <div>
                            <h3 class="text-xs font-medium tracking-[0.2em] text-warm-gray uppercase">Studio</h3>
                        ...
                        @if ($socialLinks->isNotEmpty())
                            <div>
                                <h3 class="text-xs font-medium tracking-[0.2em] text-warm-gray uppercase">Connect</h3>
